...
pub fn create_extra_tools() -> Vec<(&'static str, Arc<dyn Tool>)> {
    ...
    vec![
        ...
        ("db_query", Arc::new(DbQueryTool)),
        ("db_list_tables", Arc::new(DbListTablesTool)),
        ("db_table_info", Arc::new(DbTableInfoTool)),
        ("db_create_table", Arc::new(DbCreateTableTool)),
        ("db_insert", Arc::new(DbInsertTool)),
